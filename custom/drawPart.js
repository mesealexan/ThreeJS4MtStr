...
function drawPart(PartNo){
	...
	case 'G58R-24':  
	G58R_24 = new drawElement(99, "SR", "1.125", "pipe", "chrome", "NP", false);
	dummy.add(G58R_24);
	...
	case 'G58R-48': 
	G58R_48 = new drawElement(39, "SR", "1.75", "pipe", "chrome", "NP", false);
	dummy.add(G58R_48);
	...
	ExPipe = new drawElement(12, "Pipe",'P2x.154',"18 in P4x.237", "chrome", "NP", true);
	...
	case 'A58234':  
	A58234 = new drawElement(12, "Hex Bolt",'none',"Hex Bolt", "chrome", "NP", true);
	dummy.add(A58234);
	dummy.A58234 = A58234
		return(dummy)
		break;
	case 'A58FW':  
	A58FW = new drawElement(3, "Donut",0.3,"Donut", "chrome", "NP", true);
	dummy.add(A58FW);
	dummy.A58FW = A58FW;
		return(dummy)
		break;
	...
	case 'G58LW':  
	G58LW = new drawElement(3.5, "Donut",0.3,"Donut", "chrome", "NP", true);
	dummy.add(G58LW);
	dummy.G58LW = G58LW;
		return(dummy)
		break;
	...
	case 'A58NUT':  
	A58NUT = new drawElement(3, "Nut",2,"Nut", "chrome", "NP", true);
	dummy.add(A58NUT);
	dummy.A58NUT = A58NUT;
		return(dummy)
		break;
	...
	case 'UB5458': 
	UB5458 = new drawElement(6, "U Bolt",3.52,"U Bolt", "metal", "NP", false);
	dummy.add(UB5458);
	dummy.UB5458 = UB5458;
		return(dummy)
		break;
	...
	case 'G58FW':  
	G58FW = new drawElement(6, "Donut",0.3,"Donut", "chrome", "NP", true);
	dummy.add(G58FW);
	dummy.G58FW = G58FW;
		return(dummy)
		break;
	...
	case 'G58NUT':  
	G58NUT = new drawElement(3, "Nut",2,"Nut", "chrome", "NP", true);
	dummy.add(G58NUT);
	dummy.G58NUT = G58NUT;
		return(dummy)
		break;
	...
	case 'UB1306':  
	UB1306 = new drawElement(8.2, "U Bolt",5.11,"U Bolt", "metal", "NP", false);
	dummy.add(UB1306);
	dummy.UB1306 = UB1306;
		return(dummy)
		break;
	...
	case 'G12NUT':  
	G12NUT = new drawElement(2, "Nut",3,"Nut", "chrome", "NP", true);
	dummy.add(G12NUT);
	dummy.G12NUT = G12NUT;
		return(dummy)
		break;
	...
	case 'G12FW':  
	G12FW = new drawElement(11, "Donut",0.7,"Donut", "chrome", "NP", true);
	dummy.add(G12FW);
	dummy.G12FW = G12FW;
		return(dummy)
		break;
	...
	case 'G12LW': 
	G12LW = new drawElement(11, "Donut",0.7,"Donut", "chrome", "NP", true);
	dummy.add(G12LW);
	dummy.G12LW = G12LW;
		return(dummy)
		break;
	...
	case 'UB1212': 
	UB1212 = new drawElement(3.3, "U Bolt",2.3,"U Bolt", "metal", "NP", false);
	dummy.add(UB1212);
	dummy.UB1212 = UB1212;
		return(dummy)
		break;
	...
	case 'P3150':  
	P3150 = new drawElement(150, "Pipe",'P1.25x.14',"Pipe", "chrome", "NP", true);
	dummy.add(P3150);
	dummy.P3150 = P3150;
		return(dummy)
		break;
	...
	case 'A':  
	A = new drawElement(63, "Pipe",'P.75x.154',"Pipe", "chrome", "NP", true);
	dummy.add(A);
	dummy.A = A;
		return(dummy)
		break;
	...
	case 'SP219':  
	SP219 = new drawElement(8, "C",'C6X10.5',"C Profile", "chrome", "NP", true);
	dummy.add(SP219);
	dummy.SP219 = SP219;
		return(dummy)
		break;
	...
	case 'SP216': 
	SP216 = new drawElement(12, "C", "C10X15.3", "LARGE SUPPORT CROSS PLATE", "chrome", "NP", true);
	dummy.add(SP216);
	dummy.SP216 = SP216;
		return(dummy)
		break;
